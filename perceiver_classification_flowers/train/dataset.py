...
def _distorted_bounding_box_crop(
  ...
  target_height, target_wlabelth, _ = tf.unstack(bbox_size)
  crop_window = [offset_y, offset_x, target_height, target_wlabelth]
  ...
  im_shape = tf.stack([target_height, target_wlabelth])
  return image, im_shape
...
#   image_wlabelth = image.shape[1]
#   offset_height = ((image_height - crop_dim) + 1) // 2
#   offset_wlabelth = ((image_wlabelth - crop_dim) + 1) // 2
